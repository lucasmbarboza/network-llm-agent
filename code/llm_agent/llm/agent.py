...
from llm_agent.logger.logger_setup import logger
from llm_agent.langchain_tools.tools_list import tools
...
# Change this method to remove grafana message
...
if __name__ == "__main__":
    agent = LLMChatAgent()
    chat = agent.chat("can you check the interfaces on the Q-L-1 device?")
    print(chat)
    print("#" * 80, "\n")
    chat = agent.chat("can you check if the OSPF is configured?")
    print(chat)
    print("#" * 80, "\n")
